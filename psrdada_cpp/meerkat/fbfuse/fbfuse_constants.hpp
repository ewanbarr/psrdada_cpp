...
#define FBFUSE_TOTAL_NANTENNAS 40   // The total number of antennas in the input DADA buffer
...
#define FBFUSE_CB_NSAMPLES_PER_PACKET (FBFUSE_CB_HEAP_SIZE / FBFUSE_CB_NCHANS_OUT)
